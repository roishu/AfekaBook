...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && empty($_POST)){
	...
	if(move_uploaded_file($_FILES['file']['tmp_name'], $target_path)){
		...
		if($ext=='jpg' || $ext=='jpeg'){
			...
			$addPicToGallayQ = "INSERT INTO `gallery` (`Publisher`, `Src`, `Thumb`) VALUES('".$email."','"."server/".$target_path."','"."server/".$target_path."')";
		}
		else
			$addPicToGallayQ = "INSERT INTO `gallery` (`Publisher`, `Src`) VALUES('".$email."','"."server/".$target_path."')";
